          ...
          {open.map((item) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {item.assignee && (
                  <span className="flex items-center gap-1 text-[10px] text-gray-400 dark:text-gray-500 mt-1">
          ...
          <div className="space-y-2">
            {done.map((item) => (
              ...
              >
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 line-through leading-relaxed flex-1">
                  {item.text}
                </p>
      ...
      {adding ? (
        <div className="border border-purple-200 dark:border-purple-800 rounded-lg p-2 bg-purple-50/50 dark:bg-purple-950/20">
          <textarea
            ...
            className="w-full text-xs text-gray-700 dark:text-gray-200 bg-transparent resize-none outline-none placeholder:text-gray-400 dark:placeholder:text-gray-500"
            rows={2}
          />
          ...
          <div className="flex items-center gap-2 mt-2">
            <button
              ...
              className="text-xs font-medium text-white bg-purple-600 hover:bg-purple-700 disabled:opacity-50 px-3 py-1 rounded-md transition-colors"
            >
        ...
        <button
          ...
          className="flex items-center gap-2 text-xs text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium transition-colors w-full px-2"
        >
